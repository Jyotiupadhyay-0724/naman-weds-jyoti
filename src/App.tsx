    ...
    <div className="min-h-screen bg-white text-gray-800 overflow-x-hidden" style={{ fontFamily: '"Playfair Display", serif' }}>
      ...
      <div id="events" className="my-16">
        ...
        <div className="flex flex-col items-center justify-center space-y-8 max-w-5xl mx-auto px-4">
          <EventCard title="The Tilak Ceremony" date="Friday, February 6, 2026" time="To be announced" venue="Pandey's World, 7-E (East), Biren Roy Road E, Jadu Colony, Sarada Pally, Kolkata, West Bengal 700034" dressCode="Traditional attire" emoji="🙏" />
          ...
          <EventCard title="The Mehendi Affair" date="Monday, February 9, 2026" time="03:00 PM onwards" venue="Pandey's World, 7-E (East), Biren Roy Road E, Jadu Colony, Sarada Pally, Kolkata, West Bengal 700034" dressCode="Henna hues" emoji="🎨" />
          <EventCard title="Turmeric Tales (Haldi)" date="Monday, February 9, 2026" time="11:00 AM onwards" venue="Pandey's World, 7-E (East), Biren Roy Road E, Jadu Colony, Sarada Pally, Kolkata, West Bengal 700034" dressCode="Dipped in sunshine (Yellow)" emoji="🌼" />
